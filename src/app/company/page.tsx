    ...
    <Container className="mt-16">
      ...
      <section className="mt-16 grid grid-cols-1 lg:grid-cols-2 lg:gap-12">
        <div className="max-w-lg">
          <h2 className="text-2xl font-medium tracking-tight dark:text-gray-50">
            Our mission
          </h2>
          <p className="mt-6 text-sm/6 text-gray-600 dark:text-gray-100">
          ...
          <p className="mt-8 text-sm/6 text-gray-600 dark:text-gray-100">
        ...
        <div className="max-lg:mt-16 lg:col-span-1">
          ...
          <dl className="mt-6 grid grid-cols-1 gap-x-8 gap-y-4 sm:grid-cols-2">
            <div className="flex flex-col gap-y-2 border-b border-dotted border-gray-200 pb-4">
              <dt className="text-sm/6 text-gray-600 dark:text-gray-300">
                Raised
              </dt>
              <dd className="order-first text-6xl font-medium tracking-tight dark:text-white">
  ...
  return (
    <Container className="mt-32">
      ...
      <div className="mt-12 grid grid-cols-1 gap-12 lg:grid-cols-2">
        <div className="max-w-lg">
          <p className="text-sm/6 text-gray-600 dark:text-gray-100">
          ...
          <div className="mt-6">
            <Button variant="primary" className="w-full sm:w-auto" href="#">
              Join us
            </Button>
          </div>
        </div>
      ...
      >
        <li>
          <img
            ...
            className="h-14"
          />
          <p className="mt-6 max-w-lg text-sm/6 text-gray-500 dark:text-gray-300">
            ...
            <table className="w-full text-left">
              ...
              <tbody>
                ...
                <tr className="border-b border-dotted border-gray-200 text-sm/6 font-normal">
                  <td className="px-0 py-4 dark:text-gray-100">
                    iOS Developer
                  </td>
                  <td className="px-0 py-4 text-gray-600 dark:text-gray-400">
                    Remote
                  </td>
                ...
                <tr className="border-b border-dotted border-gray-200 text-sm/6 font-normal">
                  <td className="px-0 py-4 dark:text-gray-100">Designer</td>
                  <td className="px-0 py-4 text-gray-600 dark:text-gray-400">
                    Remote
                  </td>
                  <td className="px-0 py-4 text-right">
