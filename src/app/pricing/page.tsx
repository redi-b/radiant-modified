...
function PricingCard({ tier }: { tier: (typeof tiers)[number] }) {
  return (
    <div className="-m-2 grid grid-cols-1 rounded-4xl shadow-[inset_0_0_2px_1px_#ffffff4d] ring-1 ring-black/5 max-lg:mx-auto max-lg:w-full max-lg:max-w-md dark:ring-white/5">
      <div className="grid grid-cols-1 rounded-4xl p-2 shadow-md shadow-black/5 dark:shadow-white/5">
        <div className="rounded-3xl bg-white p-10 pb-9 shadow-2xl ring-1 ring-black/5 transition-colors duration-300 ease-in-out dark:bg-card-500 dark:ring-white/5">
          <Subheading className="dark:text-white">{tier.name}</Subheading>
          <p className="mt-2 text-sm/6 text-gray-950/75 dark:text-gray-50">
            {tier.description}
          </p>
          <div className="mt-8 flex items-center gap-4">
            <div className="text-5xl font-medium dark:text-white">
              ${tier.priceMonthly}
            </div>
            <div className="text-sm/5 text-gray-950/75 dark:text-gray-50">
              <p>USD</p>
              <p>per month</p>
            </div>
          </div>
          <div className="mt-8">
            <Button href={tier.href} variant="primary">
              Start a free trial
            </Button>
          </div>
          <div className="mt-8">
            <h3 className="text-sm/6 font-medium dark:text-gray-50">
              Start selling with:
            </h3>
        ...
        <thead>
          <tr className="max-sm:hidden">
            ...
            {tiers.map((tier) => (
              ...
              >
                <Subheading as="div" className="dark:text-white">
                  {tier.name}
                </Subheading>
              </th>
            ))}
          ...
          (section) => (
            <tbody key={section} className="group">
              <tr>
                ...
                >
                  <div className="-mx-4 rounded-lg bg-gray-50 px-4 py-3 text-sm/6 font-semibold dark:bg-gray-200">
                    {section}
                  </div>
                </th>
              </tr>
                      ...
                      return (
                        ...
                        >
                          {value === true ? (
                            ...
                            <div className="text-sm/6 dark:text-gray-50">
                              {value}
                            </div>
                          )}
                        </td>
...
function FeatureItem({
  ...
  return (
    <li
      ...
      className="flex items-start gap-4 text-sm/6 text-gray-50/75 dark:text-gray-50/75 data-disabled:dark:text-gray-100/40"
    >
      <span className="inline-flex h-6 items-center">
        <PlusIcon className="size-3.75 shrink-0 fill-gray-950/25 dark:fill-gray-50/75" />
      </span>
    ...
    <Container>
      <section id="faqs" className="scroll-mt-8">
        ...
        <div className="mx-auto mt-16 mb-32 max-w-xl space-y-12">
          <dl>
            <dt className="text-sm font-semibold dark:text-gray-50">
